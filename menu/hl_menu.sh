...
{  
    ...
    1)  ../levels/01-test/create_network_level01_session.sh;                        #splits tmux in different windows    
        return 5 ;;                                                                 #return 5 means that the function networks_levels is going to run
   2) echo -e "you chose level 2. starting..." ; ../scripts/level_start.sh 2 3 ; sudo tmux new-session -s lvl02 -d 'lxc shell lvl02-c02'\; split-window -v -d 'lxc shell lvl02-c01' \; split-window -h -d 'lxc shell lvl02-c03' \; attach ; clear ; ../levels/level2_netzwerk_arp_poisoning/Auswertung.sh ; return 5 ;;
