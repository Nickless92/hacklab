...
{  
    ...
    read menuinput
    case $menuinput in
    1) echo -e "you chose level 1. starting..." ; ../scripts/level_start.sh 1 3 ; clear ; sudo tmux new-session -s lvl01 -d 'lxc exec lvl01-d02 -- tshark -i eno1'\; split-window -v -d 'lxc shell lvl01-d01' \; split-window -h -d 'lxc exec lvl01-d03 -- tshark -i eno1' \; attach; clear ; sh ../levels/01-test/finish.sh ; sleep 10 ; return 5 ;;
