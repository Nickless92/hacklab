...
tmux new-window -t hacklab:1 -n help 'tail -11 levels/01-test/story.txt ; bash -i'         # create a new window and run

tmux new-window -t hacklab:2 -n topology 'cat levels/01-test/topology.txt; bash -i'        # create a new window and run
