...
./levels/02/storytime.sh                                                              # story time :)
...
tmux new-window -t hacklab:1 -n help 'cat ./levels/02/anweisung.txt; bash -i'                       # create a new window and run
...
clear 
 . ./levels/02/Auswertung.sh                                               # evaluation of the level
sleep 3
cd - > /dev/null
