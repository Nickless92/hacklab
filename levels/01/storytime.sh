...
clear
sleep 1s
print_paragraph_from_file 1 ./levels/01/story.txt 1s                      # type 1-3 line with --- and new line at the end
...
print_paragraph_from_file 2 ./levels/01/story.txt 1s
wait_for_any_key

echo -e "\n"
loading_arrows .5s; print_paragraph_from_file 3 ./levels/01/story.txt 1s
loading_arrows .5s; print_paragraph_from_file 4 ./levels/01/story.txt 1s
loading_arrows .5s; print_paragraph_from_file 5 ./levels/01/story.txt 1s
loading_arrows .5s; print_paragraph_from_file 6 ./levels/01/story.txt 1s
sleep 1s
